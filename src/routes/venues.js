 ...
 *         schema:
 *           type: string
 *           enum: [name, type, impact_factor, created_at]
...
router.get(
  ...
  [
    ...
    query('sortBy')
      .optional()
      .isIn(['name', 'type', 'impact_factor', 'created_at', 'works_count'])
      .withMessage('Sort field must be one of: name, type, impact_factor, created_at, works_count'),
    query('sortOrder')
      .optional()
      .isIn(['ASC', 'DESC'])
