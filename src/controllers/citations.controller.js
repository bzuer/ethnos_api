    ...
    try {
      ...
      if (!result) {
        ...
        return res.status(404).json({
          status: 'error',
          message: `Citations for work with ID ${workId} not found`
        });
      }
      ...
      res.status(500).json({
        status: 'error',
        message: 'Failed to retrieve work citations'
      });
    }
  }
  ...
  async getWorkReferences(req, res) {
    try {
      ...
      if (!result) {
        ...
        return res.status(404).json({
          status: 'error',
          message: `References for work with ID ${workId} not found`
        });
      }
      ...
      res.status(500).json({
        status: 'error',
        message: 'Failed to retrieve work references'
      });
    }
  }
  ...
  async getWorkMetrics(req, res) {
    try {
      ...
      if (!result) {
        ...
        return res.status(404).json({
          status: 'error',
          message: `Metrics for work with ID ${workId} not found`
        });
      }
      ...
      res.status(500).json({
        status: 'error',
        message: 'Failed to retrieve work metrics'
      });
    }
  }
  ...
  async getCitationNetwork(req, res) {
    try {
      ...
      if (!result) {
        ...
        return res.status(404).json({
          status: 'error',
          message: `Citation network for work with ID ${workId} not found`
        });
      }
      ...
      res.status(500).json({
        status: 'error',
        message: 'Failed to retrieve citation network'
      });
    }
  }
}
